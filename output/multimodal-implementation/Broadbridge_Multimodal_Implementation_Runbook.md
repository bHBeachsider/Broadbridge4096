...
The earlier 24-week schedule was a top-level target. Explicit finish-to-start dependencies and daily effort limits produce a proposed 152-working-day baseline, about 31 weeks. Gate dates are calculated from the workbook inputs. This replaces the earlier milestone timing for implementation planning; it does not authorize spending. Rebaseline the 24-week budget and first-eight-week funding limit before execution. Work must not silently continue past an authorized tranche.
